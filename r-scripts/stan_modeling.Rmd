...
# Interpretation: average speed across the sample was 9.447 mph, an increase of 1 in lane_perc (+ 1 percentage point additional lane coverage) is associated with an increase of 1.2 mph on average
...
L <- max(as.numeric(df$borough))
l_index <- as.numeric(df$borough)
...
fit5$summary(variables = c("beta0", "theta", "beta_l_z", "sigma", "sigma_r", "beta_i", "beta_j", "beta_l"))
```
